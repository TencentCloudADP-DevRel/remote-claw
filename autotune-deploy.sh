...
OPENCLAW_IMAGE=tencentcloudadpdevrel/openclaw-desktop:latest
...
deploy_or_update() {
    ...
    if [ "$first_install" = "yes" ]; then
        echo "Detected first installation. Pulling image and starting container..."
    else
        echo "Detected existing installation. Pulling latest image and rolling update..."
    fi
